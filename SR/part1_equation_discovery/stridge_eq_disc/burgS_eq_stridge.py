...
data = pd.read_csv("..\eit\SR\part1_eqation_discovery\data\\burgers_data.csv",  encoding='utf-8') #%%Check the solution 
...
plt.show()
print(coef)
np.savez('burgS_str0.npz', coef=cf, dtol= otol, lam=alphas, test_mse=test_mse)