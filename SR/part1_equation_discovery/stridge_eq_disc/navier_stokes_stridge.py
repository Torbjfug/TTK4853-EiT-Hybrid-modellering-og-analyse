...
if(platform.system() == 'Windows'): #Windows
    ...
    print(os.listdir("/lustre1/home/gustavoo/TTK4853-EiT-Hybrid-modellering-og-analyse/SR/part1_equation_discovery/data"))
    navier_data = pd.read_csv("/lustre1/home/gustavoo/TTK4853-EiT-Hybrid-modellering-og-analyse/SR/part1_equation_discovery/data/navier_stokes_data_u.csv",  encoding='utf-8')
